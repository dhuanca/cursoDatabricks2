...
# MAGIC %md
# MAGIC Pasajeros que viajan mensualmente en miles por avion desde enero 1949 hasta diciembre 1960
...
airline = pd.read_csv("/dbfs/FileStore/airline_passengers.csv", index_col='Month', parse_dates=True)
