...
with mlflow.start_run(run_name='random_forest_no_tuneado3'):
  n_estimators = 10
...
run_id = mlflow.search_runs(filter_string='tags.mlflow.runName = "random_forest_no_tuneado3"').iloc[0].run_id
print(run_id)

# COMMAND ----------

model_name = "wine_quality3"
...
with mlflow.start_run(run_name='xgboost_models3'):
  best_params = fmin(
    fn=train_model, 
    space=search_space, 
    algo=algo, 
...
import os
os.environ["DATABRICKS_TOKEN"] = "dapic778dc0ee538b246ab28a2ba9b0f1823-3"
...
# COMMAND ----------
    ...
    def score_model(dataset):
      url = 'https://adb-391786651348740.0.azuredatabricks.net/serving-endpoints/PRueba_wine_predit/invocations'
